...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    CSAHi Normal term=NONE cterm=NONE ctermbg=59 ctermfg=231 gui=NONE guibg=#4e4e68 guifg=#ffffff
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=23 ctermfg=23 gui=bold guibg=#2e4e4e guifg=#2e4e4e
    CSAHi Directory term=bold cterm=NONE ctermbg=59 ctermfg=149 gui=NONE guibg=#43435d guifg=#afeb4b
    ...
    CSAHi Search term=reverse cterm=NONE ctermbg=17 ctermfg=16 gui=NONE guibg=#2e2e4e guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=59 ctermfg=227 gui=bold guibg=#4e4e68 guifg=#ffff4b
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=202 gui=bold guibg=#000000 guifg=#ff4400
    CSAHi LineNr term=underline cterm=NONE ctermbg=53 ctermfg=137 gui=NONE guibg=#4e2e4e guifg=#b98b4b
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=226 ctermfg=226 gui=NONE guibg=#ffff00 guifg=#ffff00
    CSAHi Pmenu term=NONE cterm=NONE ctermbg=233 ctermfg=fg gui=NONE guibg=#141414 guifg=fg
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=226 ctermfg=21 gui=NONE guibg=Yellow guifg=Blue
    ...
    CSAHi CursorLine term=underline cterm=NONE ctermbg=17 ctermfg=fg gui=NONE guibg=#2e2e4e guifg=fg
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=59 ctermfg=102 gui=NONE guibg=#4e4e68 guifg=#878787
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=59 ctermfg=77 gui=NONE guibg=#4e4e68 guifg=#5dca4b
    CSAHi Statement term=bold cterm=bold ctermbg=59 ctermfg=167 gui=bold guibg=#4e4e68 guifg=#c5713c
    CSAHi PreProc term=underline cterm=bold ctermbg=59 ctermfg=134 gui=bold guibg=#43435d guifg=#af4bd7
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=179 gui=NONE guibg=bg guifg=#e1c34b
    ...
    CSAHi Constant term=underline cterm=NONE ctermbg=59 ctermfg=17 gui=NONE guibg=#52526c guifg=#0e0e5a
    ...
    CSAHi DiffChange term=bold cterm=NONE ctermbg=242 ctermfg=226 gui=NONE guibg=#6c6c68 guifg=#ffff00
    CSAHi vimExtCmd term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Special term=bold cterm=bold ctermbg=59 ctermfg=176 gui=bold guibg=#4e4e68 guifg=#e589c5
    ...
    CSAHi htmlComment term=NONE cterm=NONE ctermbg=59 ctermfg=102 gui=NONE guibg=#4e4e68 guifg=#878787
    CSAHi htmlCommentPart term=NONE cterm=NONE ctermbg=59 ctermfg=102 gui=NONE guibg=#4e4e68 guifg=#878787
    CSAHi htmlLink term=NONE cterm=NONE ctermbg=60 ctermfg=55 gui=NONE guibg=#5d5d77 guifg=#6501b5
    ...
    CSAHi Question term=NONE cterm=bold ctermbg=59 ctermfg=227 gui=bold guibg=#4e4e68 guifg=#ffff4b
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=136 ctermfg=101 gui=bold guibg=#ae8604 guifg=#91874b
    CSAHi StatusLineNC term=reverse cterm=bold ctermbg=142 ctermfg=52 gui=bold guibg=#aea404 guifg=#430000
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=16 ctermfg=236 gui=NONE guibg=#000000 guifg=#2e2e34
    CSAHi Title term=bold cterm=NONE ctermbg=59 ctermfg=132 gui=NONE guibg=#4e4e68 guifg=#c3559b
    CSAHi Visual term=reverse cterm=NONE ctermbg=101 ctermfg=16 gui=NONE guibg=#807668 guifg=#000000
    ...
    CSAHi Folded term=NONE cterm=NONE ctermbg=58 ctermfg=58 gui=NONE guibg=#4e4e2e guifg=#4e4e2e
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=59 ctermfg=226 gui=NONE guibg=#4e6c68 guifg=#ffff00
    CSAHi vimAuSyntax term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi DiffDelete term=bold cterm=bold ctermbg=59 ctermfg=226 gui=bold guibg=#6c4e68 guifg=#ffff00
    CSAHi DiffText term=reverse cterm=bold ctermbg=60 ctermfg=231 gui=bold guibg=#4e4e86 guifg=#ffffff
...
elseif has("gui_running") || &t_Co == 88
    CSAHi Normal term=NONE cterm=NONE ctermbg=37 ctermfg=79 gui=NONE guibg=#4e4e68 guifg=#ffffff
    CSAHi rubyHeredocStart term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyAliasDeclaration2 term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyAliasDeclaration term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyMethodDeclaration term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=21 ctermfg=21 gui=bold guibg=#2e4e4e guifg=#2e4e4e
    CSAHi Directory term=bold cterm=NONE ctermbg=17 ctermfg=61 gui=NONE guibg=#43435d guifg=#afeb4b
    ...
    CSAHi Search term=reverse cterm=NONE ctermbg=17 ctermfg=16 gui=NONE guibg=#2e2e4e guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=37 ctermfg=77 gui=bold guibg=#4e4e68 guifg=#ffff4b
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=64 gui=bold guibg=#000000 guifg=#ff4400
    CSAHi LineNr term=underline cterm=NONE ctermbg=33 ctermfg=53 gui=NONE guibg=#4e2e4e guifg=#b98b4b
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=76 ctermfg=76 gui=NONE guibg=#ffff00 guifg=#ffff00
    CSAHi Pmenu term=NONE cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#141414 guifg=fg
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=76 ctermfg=19 gui=NONE guibg=Yellow guifg=Blue
    CSAHi PmenuSbar term=NONE cterm=NONE ctermbg=85 ctermfg=fg gui=NONE guibg=Grey guifg=fg
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=79 ctermfg=37 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi perlBracketsSQ term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlBracesSQ term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi lCursor term=NONE cterm=NONE ctermbg=79 ctermfg=37 gui=NONE guibg=fg guifg=bg
    CSAHi vimSynRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSynPatMod term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=37 ctermfg=83 gui=NONE guibg=#4e4e68 guifg=#878787
    CSAHi vimSyncLines term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSyncMatch term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Identifier term=underline cterm=NONE ctermbg=37 ctermfg=41 gui=NONE guibg=#4e4e68 guifg=#5dca4b
    CSAHi Statement term=bold cterm=bold ctermbg=37 ctermfg=52 gui=bold guibg=#4e4e68 guifg=#c5713c
    CSAHi PreProc term=underline cterm=bold ctermbg=17 ctermfg=54 gui=bold guibg=#43435d guifg=#af4bd7
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=57 gui=NONE guibg=bg guifg=#e1c34b
    CSAHi rubyDoBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyCurlyBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyArrayDelimiter term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyArrayLiteral term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi Ignore term=NONE cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=bg
    ...
    CSAHi vimPatRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlSync term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Constant term=underline cterm=NONE ctermbg=37 ctermfg=17 gui=NONE guibg=#52526c guifg=#0e0e5a
    CSAHi vimCommentTitleLeader term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimGlobal term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlGenericBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi DiffChange term=bold cterm=NONE ctermbg=82 ctermfg=76 gui=NONE guibg=#6c6c68 guifg=#ffff00
    CSAHi vimExtCmd term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Special term=bold cterm=bold ctermbg=37 ctermfg=54 gui=bold guibg=#4e4e68 guifg=#e589c5
    CSAHi pythonSpaceError term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimCollection term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSubstPat term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSubstRep4 term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi htmlComment term=NONE cterm=NONE ctermbg=37 ctermfg=83 gui=NONE guibg=#4e4e68 guifg=#878787
    CSAHi htmlCommentPart term=NONE cterm=NONE ctermbg=37 ctermfg=83 gui=NONE guibg=#4e4e68 guifg=#878787
    CSAHi htmlLink term=NONE cterm=NONE ctermbg=37 ctermfg=34 gui=NONE guibg=#5d5d77 guifg=#6501b5
    CSAHi vimMenuMap term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimMenuRhs term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Question term=NONE cterm=bold ctermbg=37 ctermfg=77 gui=bold guibg=#4e4e68 guifg=#ffff4b
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=52 ctermfg=37 gui=bold guibg=#ae8604 guifg=#91874b
    CSAHi StatusLineNC term=reverse cterm=bold ctermbg=52 ctermfg=16 gui=bold guibg=#aea404 guifg=#430000
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=16 ctermfg=80 gui=NONE guibg=#000000 guifg=#2e2e34
    CSAHi Title term=bold cterm=NONE ctermbg=37 ctermfg=53 gui=NONE guibg=#4e4e68 guifg=#c3559b
    CSAHi Visual term=reverse cterm=NONE ctermbg=37 ctermfg=16 gui=NONE guibg=#807668 guifg=#000000
    CSAHi vimGroupList term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi WarningMsg term=NONE cterm=NONE ctermbg=83 ctermfg=16 gui=NONE guibg=#888888 guifg=#000000
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=76 ctermfg=16 gui=NONE guibg=Yellow guifg=Black
    CSAHi Folded term=NONE cterm=NONE ctermbg=36 ctermfg=36 gui=NONE guibg=#4e4e2e guifg=#4e4e2e
    CSAHi rubyLocalVariableOrMethod term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyBlockArgument term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyBlockParameterList term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=37 ctermfg=76 gui=NONE guibg=#4e6c68 guifg=#ffff00
    CSAHi vimAuSyntax term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi DiffDelete term=bold cterm=bold ctermbg=37 ctermfg=76 gui=bold guibg=#6c4e68 guifg=#ffff00
    CSAHi DiffText term=reverse cterm=bold ctermbg=37 ctermfg=79 gui=bold guibg=#4e4e86 guifg=#ffffff
    CSAHi vimClusterName term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimGroupName term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
