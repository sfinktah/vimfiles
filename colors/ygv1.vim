...
elseif &background == "dark"
    ...
    hi Comment gui=NONE guifg=#636363 guibg=NONE
    hi Conceal gui=NONE guifg=#707070 guibg=NONE
    hi Conditional gui=NONE guifg=#c4b900 guibg=NONE
    hi Constant gui=NONE guifg=#707070 guibg=NONE
    hi Cursor gui=reverse guifg=NONE guibg=NONE
    ...
    hi DiffAdd gui=NONE guifg=NONE guibg=#032603
    hi DiffChange gui=NONE guifg=NONE guibg=#171717
    hi DiffDelete gui=NONE guifg=NONE guibg=#260303
    hi DiffText gui=NONE guifg=NONE guibg=#2e2e2e
    hi Directory gui=NONE guifg=#7d7d7d guibg=NONE
    hi Error gui=NONE guifg=NONE guibg=#260303
    hi ErrorMsg gui=NONE guifg=NONE guibg=#260303
    ...
    hi ModeMsg gui=NONE guifg=NONE guibg=NONE
    hi MoreMsg gui=NONE guifg=NONE guibg=NONE
    hi NonText gui=NONE guifg=#545454 guibg=#100c05
    hi Normal gui=NONE guifg=#377500 guibg=#0f150f
    ...
    hi Special gui=italic guifg=#8a8a8a guibg=NONE
    hi SpecialKey gui=NONE guifg=#545454 guibg=NONE
    hi SpellBad gui=undercurl guisp=NONE guifg=NONE guibg=#260303
    hi SpellCap gui=undercurl guisp=NONE guifg=NONE guibg=NONE
    hi SpellLocal gui=undercurl guisp=NONE guifg=NONE guibg=#032603
    hi SpellRare gui=undercurl guisp=NONE guifg=NONE guibg=#212121
    hi Statement gui=NONE guifg=#80bc00 guibg=NONE
    hi StatusLine gui=NONE guifg=#8a8a8a guibg=#212121
    hi StatusLineNC gui=NONE guifg=#636363 guibg=#212121
    hi StorageClass gui=NONE guifg=#2c5777 guibg=NONE
    hi String gui=NONE guifg=#74aa00 guibg=NONE
