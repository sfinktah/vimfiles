...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    CSAHi Normal term=NONE cterm=NONE ctermbg=59 ctermfg=231 gui=NONE guibg=#494961 guifg=#ffffff
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=23 ctermfg=23 gui=bold guibg=#294949 guifg=#294949
    CSAHi Directory term=bold cterm=NONE ctermbg=59 ctermfg=155 gui=NONE guibg=#3e3e56 guifg=#b3ef4f
    ...
    CSAHi Search term=reverse cterm=NONE ctermbg=17 ctermfg=16 gui=NONE guibg=#292949 guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=59 ctermfg=227 gui=bold guibg=#494961 guifg=#ffff4f
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=226 gui=bold guibg=#000000 guifg=#ffff00
    CSAHi LineNr term=underline cterm=NONE ctermbg=53 ctermfg=137 gui=NONE guibg=#492949 guifg=#bd8f4f
    CSAHi Comment term=bold cterm=NONE ctermbg=59 ctermfg=245 gui=NONE guibg=#494961 guifg=#8b8b8b
    ...
    CSAHi Pmenu term=NONE cterm=NONE ctermbg=233 ctermfg=fg gui=NONE guibg=#101010 guifg=fg
    ...
    CSAHi CursorLine term=underline cterm=NONE ctermbg=17 ctermfg=fg gui=NONE guibg=#292949 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=226 ctermfg=231 gui=NONE guibg=#ffff00 guifg=#ffffff
    ...
    CSAHi Special term=bold cterm=bold ctermbg=59 ctermfg=176 gui=bold guibg=#494961 guifg=#e78bc7
    CSAHi Identifier term=underline cterm=NONE ctermbg=59 ctermfg=77 gui=NONE guibg=#494961 guifg=#61ce4f
    CSAHi Statement term=bold cterm=bold ctermbg=59 ctermfg=167 gui=bold guibg=#494961 guifg=#c7733e
    CSAHi PreProc term=underline cterm=bold ctermbg=59 ctermfg=134 gui=bold guibg=#3e3e56 guifg=#b34fdb
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=185 gui=NONE guibg=bg guifg=#e5c74f
    ...
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=136 ctermfg=58 gui=bold guibg=#a77f00 guifg=#423800
    ...
    CSAHi Question term=NONE cterm=bold ctermbg=59 ctermfg=227 gui=bold guibg=#494961 guifg=#ffff4f
    CSAHi Constant term=underline cterm=NONE ctermbg=59 ctermfg=17 gui=NONE guibg=#4d4d65 guifg=#151561
    ...
    CSAHi htmlComment term=NONE cterm=NONE ctermbg=59 ctermfg=245 gui=NONE guibg=#494961 guifg=#8b8b8b
    CSAHi htmlCommentPart term=NONE cterm=NONE ctermbg=59 ctermfg=245 gui=NONE guibg=#494961 guifg=#8b8b8b
    CSAHi htmlLink term=NONE cterm=NONE ctermbg=59 ctermfg=135 gui=NONE guibg=#3e3e56 guifg=#b34fff
    ...
    CSAHi StatusLineNC term=reverse cterm=bold ctermbg=142 ctermfg=52 gui=bold guibg=#a79d00 guifg=#440000
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=16 ctermfg=17 gui=NONE guibg=#000000 guifg=#292930
    CSAHi Title term=bold cterm=NONE ctermbg=59 ctermfg=169 gui=NONE guibg=#494961 guifg=#c7599f
    CSAHi Visual term=reverse cterm=NONE ctermbg=95 ctermfg=16 gui=NONE guibg=#7b7161 guifg=#000000
    ...
    CSAHi Folded term=NONE cterm=NONE ctermbg=58 ctermfg=58 gui=NONE guibg=#494929 guifg=#494929
    CSAHi DiffText term=reverse cterm=bold ctermbg=60 ctermfg=231 gui=bold guibg=#49497f guifg=#ffffff
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=59 ctermfg=226 gui=NONE guibg=#496761 guifg=#ffff00
    CSAHi DiffChange term=bold cterm=NONE ctermbg=241 ctermfg=226 gui=NONE guibg=#676761 guifg=#ffff00
    CSAHi DiffDelete term=bold cterm=bold ctermbg=59 ctermfg=226 gui=bold guibg=#674961 guifg=#ffff00
...
elseif has("gui_running") || &t_Co == 88
    CSAHi Normal term=NONE cterm=NONE ctermbg=81 ctermfg=79 gui=NONE guibg=#494961 guifg=#ffffff
    CSAHi rubyHeredocStart term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyAliasDeclaration2 term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyAliasDeclaration term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimFiletype term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=21 ctermfg=21 gui=bold guibg=#294949 guifg=#294949
    CSAHi Directory term=bold cterm=NONE ctermbg=17 ctermfg=61 gui=NONE guibg=#3e3e56 guifg=#b3ef4f
    ...
    CSAHi Search term=reverse cterm=NONE ctermbg=17 ctermfg=16 gui=NONE guibg=#292949 guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=81 ctermfg=77 gui=bold guibg=#494961 guifg=#ffff4f
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=76 gui=bold guibg=#000000 guifg=#ffff00
    CSAHi LineNr term=underline cterm=NONE ctermbg=33 ctermfg=53 gui=NONE guibg=#492949 guifg=#bd8f4f
    CSAHi Comment term=bold cterm=NONE ctermbg=81 ctermfg=83 gui=NONE guibg=#494961 guifg=#8b8b8b
    CSAHi vimClusterName term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimGroupName term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Pmenu term=NONE cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#101010 guifg=fg
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=76 ctermfg=19 gui=NONE guibg=Yellow guifg=Blue
    CSAHi PmenuSbar term=NONE cterm=NONE ctermbg=85 ctermfg=fg gui=NONE guibg=Grey guifg=fg
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=79 ctermfg=81 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#111100 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=17 ctermfg=fg gui=NONE guibg=#292949 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=76 ctermfg=79 gui=NONE guibg=#ffff00 guifg=#ffffff
    CSAHi vimSyncLines term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyMethodDeclaration term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyClassDeclaration term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyModuleDeclaration term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi perlParensSQ term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi VimSynMtchCchar term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi lCursor term=NONE cterm=NONE ctermbg=79 ctermfg=81 gui=NONE guibg=fg guifg=bg
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=76 ctermfg=76 gui=NONE guibg=#ffff00 guifg=#ffff00
    CSAHi vimSynRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSynPatMod term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Special term=bold cterm=bold ctermbg=81 ctermfg=70 gui=bold guibg=#494961 guifg=#e78bc7
    CSAHi Identifier term=underline cterm=NONE ctermbg=81 ctermfg=41 gui=NONE guibg=#494961 guifg=#61ce4f
    CSAHi Statement term=bold cterm=bold ctermbg=81 ctermfg=52 gui=bold guibg=#494961 guifg=#c7733e
    CSAHi PreProc term=underline cterm=bold ctermbg=17 ctermfg=54 gui=bold guibg=#3e3e56 guifg=#b34fdb
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=57 gui=NONE guibg=bg guifg=#e5c74f
    CSAHi rubyDoBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyCurlyBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyArrayDelimiter term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyArrayLiteral term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi Ignore term=NONE cterm=NONE ctermbg=bg ctermfg=81 gui=NONE guibg=bg guifg=bg
    ...
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=36 ctermfg=16 gui=bold guibg=#a77f00 guifg=#423800
    CSAHi rubyOptionalDoLine term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyRepeatExpression term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimExecute term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimIf term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimSynMatchRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimPatRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Question term=NONE cterm=bold ctermbg=81 ctermfg=77 gui=bold guibg=#494961 guifg=#ffff4f
    CSAHi Constant term=underline cterm=NONE ctermbg=81 ctermfg=17 gui=NONE guibg=#4d4d65 guifg=#151561
    CSAHi vimHiTermcap term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimCommentTitleLeader term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimGlobal term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlGenericBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimMenuPriority term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlStatementIndirObjWrap term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi htmlComment term=NONE cterm=NONE ctermbg=81 ctermfg=83 gui=NONE guibg=#494961 guifg=#8b8b8b
    CSAHi htmlCommentPart term=NONE cterm=NONE ctermbg=81 ctermfg=83 gui=NONE guibg=#494961 guifg=#8b8b8b
    CSAHi htmlLink term=NONE cterm=NONE ctermbg=17 ctermfg=55 gui=NONE guibg=#3e3e56 guifg=#b34fff
    CSAHi vimMenuMap term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimMenuRhs term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi StatusLineNC term=reverse cterm=bold ctermbg=36 ctermfg=16 gui=bold guibg=#a79d00 guifg=#440000
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=16 ctermfg=80 gui=NONE guibg=#000000 guifg=#292930
    CSAHi Title term=bold cterm=NONE ctermbg=81 ctermfg=53 gui=NONE guibg=#494961 guifg=#c7599f
    CSAHi Visual term=reverse cterm=NONE ctermbg=37 ctermfg=16 gui=NONE guibg=#7b7161 guifg=#000000
    CSAHi vimNormCmds term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi WarningMsg term=NONE cterm=NONE ctermbg=83 ctermfg=16 gui=NONE guibg=#888888 guifg=#000000
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=76 ctermfg=16 gui=NONE guibg=Yellow guifg=Black
    CSAHi Folded term=NONE cterm=NONE ctermbg=36 ctermfg=36 gui=NONE guibg=#494929 guifg=#494929
    CSAHi DiffText term=reverse cterm=bold ctermbg=37 ctermfg=79 gui=bold guibg=#49497f guifg=#ffffff
    CSAHi rubyLocalVariableOrMethod term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyBlockArgument term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyBlockParameterList term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimIsCommand term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=81 ctermfg=76 gui=NONE guibg=#496761 guifg=#ffff00
    CSAHi DiffChange term=bold cterm=NONE ctermbg=81 ctermfg=76 gui=NONE guibg=#676761 guifg=#ffff00
    CSAHi DiffDelete term=bold cterm=bold ctermbg=81 ctermfg=76 gui=bold guibg=#674961 guifg=#ffff00
    CSAHi vimAuSyntax term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
