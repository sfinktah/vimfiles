...
syntax keyword javaScriptPplSimBrowser  asyncScriptTimeout clickElementByClassName clickElementByCssSelector clickElementById clickElementByLinkText clickElementByName clickElementByPartialLinkText clickElementByTagName clickElementByXPath closeWindow doubleClick elementClear elementClick elementClickByClassName elementClickByCssSelector elementClickById elementClickByLinkText elementClickByName elementClickByPartialLinkText elementClickByTagName elementClickByXPath elementCssGet elementDisplayed elementEnabled elementEquals elementGetAttribute elementGetName elementLocation elementLocationInView elementSelected elementSetValue elementSize elementSubmit elementText executeJs executeJsAsync fileGetContents filePutContents findElementByClassName findElementByCssSelector findElementById findElementByLinkText findElementByName findElementByPartialLinkText findElementByTagName findElementByXPath findElementsByClassName findElementsByCssSelector findElementsByLinkText findElementsByName findElementsByPartialLinkText findElementsByTagName findElementsByXPath fzUpdate getUrl implicitTimeout include jsClickElementByClassName jsClickElementById localGet localGetWithParams localPost log mouseClick mouseDown mouseMove mouseMoveToElement mouseUp pageLoadTimeout pageTitle propGet propSet require screen screenShot screenShotBase64 scriptTimeout setUploadFile settings sleep source stderr stdout switchFrame switchFrameById switchFrameByName switchToWindow topFrame type typeInElement url usleep windowCount
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink javaScriptPplSimBrowser        Special
